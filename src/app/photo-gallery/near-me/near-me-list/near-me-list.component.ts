...
@Component({
  selector: 'dwu-near-me-list',
  templateUrl: './near-me-list.component.html',
  styleUrls: ['./near-me-list.component.scss']
})
export class NearMeListComponent {
  ...
  public onListSelectUploadFileId(fileId: string) {
  ...
  //     },
  //   };
  //   this.router.navigate(['../grid'], navgateOptions)
  }
